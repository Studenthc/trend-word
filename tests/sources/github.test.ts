...
describe("GitHub adapter", () => {
  it("maps repository search fields and README excerpt", async () => {
    ...
    expect(result.signals[0]).toMatchObject({ sourceUrl: "https://github.com/acme/flowpilot", title: "acme/flowpilot", body: "Workflow automation", excerpt: "Build workflows with AI.", author: { name: "acme" }, publishedAt: "2026-08-20T00:00:00.000Z", engagement: { stars: 812 } });
  });
