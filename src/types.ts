...
export const discoverySummarySchema = z.object({
  ...
  feedbackAttempted: z.number().int().nonnegative().optional(),
  feedbackSucceeded: z.number().int().nonnegative().optional(),
  feedbackUnavailable: z.number().int().nonnegative().optional(),
